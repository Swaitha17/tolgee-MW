...
const getTheme = (mode: PaletteMode) => {
  ...
  return createTheme({
    ...
    palette: {
      ...
      navbarBackground: createColor(c.navbarBackground),
      common: {
        white: c.white,
      },
      text: {
      ...
      divider1: createColor(c.divider1),
      cellSelected1: createColor(c.cellSelected1),
      cellSelected2: createColor(c.cellSelected2),
      background: {
